...
import com.spr.jflow.McontentApp;
...
@SpringBootTest(classes = McontentApp.class)
public class GscontentResourceIntTest {
    ...
    @Autowired
    private GscontentMapper gscontentMapper;
    ...
    public void setup() {
        ...
        final GscontentResource gscontentResource = new GscontentResource(gscontentService);
    ...
    public void createGscontent() throws Exception {
        ...
        GscontentDTO gscontentDTO = gscontentMapper.toDto(gscontent);
        restGscontentMockMvc.perform(post("/api/gscontents")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(gscontentDTO)))
    ...
    public void updateGscontent() throws Exception {
        ...
        GscontentDTO gscontentDTO = gscontentMapper.toDto(updatedGscontent);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(GscontentDTO.class);
        GscontentDTO gscontentDTO1 = new GscontentDTO();
        gscontentDTO1.setId(1L);
        GscontentDTO gscontentDTO2 = new GscontentDTO();
        assertThat(gscontentDTO1).isNotEqualTo(gscontentDTO2);
        gscontentDTO2.setId(gscontentDTO1.getId());
        assertThat(gscontentDTO1).isEqualTo(gscontentDTO2);
        gscontentDTO2.setId(2L);
        assertThat(gscontentDTO1).isNotEqualTo(gscontentDTO2);
        gscontentDTO1.setId(null);
        assertThat(gscontentDTO1).isNotEqualTo(gscontentDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(gscontentMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(gscontentMapper.fromId(null)).isNull();
    }
}
