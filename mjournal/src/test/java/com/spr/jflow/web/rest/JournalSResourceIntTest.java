...
public class JournalSResourceIntTest {
    ...
    public void setup() {
        ...
        final JournalSResource journalSResource = new JournalSResource(journalSService);
    ...
    public void createJournalS() throws Exception {
        ...
        // Create the JournalS
        JournalSDTO journalSDTO = journalSMapper.toDto(journalS);
        restJournalSMockMvc.perform(post("/api/journal-s")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(journalSDTO)))
    ...
    public void updateJournalS() throws Exception {
        ...
        JournalSDTO journalSDTO = journalSMapper.toDto(updatedJournalS);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(JournalSDTO.class);
        JournalSDTO journalSDTO1 = new JournalSDTO();
        journalSDTO1.setId(1L);
        JournalSDTO journalSDTO2 = new JournalSDTO();
        assertThat(journalSDTO1).isNotEqualTo(journalSDTO2);
        journalSDTO2.setId(journalSDTO1.getId());
        assertThat(journalSDTO1).isEqualTo(journalSDTO2);
        journalSDTO2.setId(2L);
        assertThat(journalSDTO1).isNotEqualTo(journalSDTO2);
        journalSDTO1.setId(null);
        assertThat(journalSDTO1).isNotEqualTo(journalSDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(journalSMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(journalSMapper.fromId(null)).isNull();
    }
}
