...
import { JflowgatewayTestModule } from '../../../../test.module';
import { JournalSUpdateComponent } from 'app/entities/mjournal/journal-s/journal-s-update.component';
    ...
    describe('JournalS Management Update Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [JflowgatewayTestModule],
